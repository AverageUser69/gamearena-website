                    ...
                    <div class="row g-0">
                        <div class="col-md-4 gradient-custom-made text-center text-white"
                            ...
                            <h5><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                </svg> <?php echo $datauser['username'];?></h5>
                        ...
                        <div class="col-md-8">
                            <div class="card-body p-4">
                                <h6><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    </svg> Unique code:#<?php echo $datauser['id'];?></h6>
                                <hr class="mt-0 mb-4">
                                <div class="row pt-1">
                                    <div class="col-6 mb-3">
                                        <h6>Email <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                                                <path
                                                    d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                                            </svg></h6>
                                        <p class="text-muted"><?php echo $datauser['email'];?></p>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <h6>Phone <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <p class="text-muted"><?php echo $datauser['phonenumber'];?></p>
                                    </div>
                                </div>
                                <h6>Games <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <div class="row pt-1">
                                    <div class="col-6 mb-3">
                                        <h6>Recently Played <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                height="16" fill="currentColor" class="bi bi-dice-5"
                                                viewBox="0 0 16 16">
                                                <path
                                    ...
                                    <div class="col-6 mb-3">
                                        <h6>Wishlist <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div class="p_btn">
                                        <a class="primary_btn" href="updateprofile.php"><span>Update Information <svg
